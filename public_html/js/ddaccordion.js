...
ddaccordion.init({
	...
	togglehtml: ["suffix", "<img src='images/butt.gif' class='statusicon' />", "<img src='images/butt-ho.gif' class='statusicon' />"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
