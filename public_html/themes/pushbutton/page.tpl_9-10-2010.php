...
if($page==trim('th'))
{
 header('location:http://test.uniquesofts.info/thaieyenew/th/th_home');
}
...
<head>
  ...
  <!--slide-->
<link rel="stylesheet" type="text/css" href="http://test.uniquesofts.info/thaieyenew/slider/contentslider.css" />
<script type="text/javascript" src="http://test.uniquesofts.info/thaieyenew/slider/contentslider.js"></script>
<!--slide-->

<!--tab-->
<script type="text/javascript" src="http://test.uniquesofts.info/thaieyenew/js/events.js"></script>
<script type="text/javascript" src="http://test.uniquesofts.info/thaieyenew/js/tabs.js"></script>
<link  type="text/css" media="screen" rel="stylesheet" href="http://test.uniquesofts.info/thaieyenew/css/tabs.css">
...
<![endif]-->
<!--tab-->
<link rel="stylesheet" type="text/css" href="http://test.uniquesofts.info/thaieyenew/tab2/tab.css">
<script type="text/javascript" src="http://test.uniquesofts.info/thaieyenew/tab2/jquery.min.js"></script>
...
?>
<!--gallery -->
<script type="text/javascript" src="http://test.uniquesofts.info/thaieyenew/gallery/jquery.tools.min.js"></script>

<? }?>

<link rel="stylesheet" type="text/css" href="http://test.uniquesofts.info/thaieyenew/gallery/gallery.css">
<!--gallery -->
...
<!--start header -->
<div id="header">
<div class="logo"><? if($lang!='th'){?><a href="http://test.uniquesofts.info/thaieyenew/home"><img src="http://test.uniquesofts.info/thaieyenew/images/logo.png" alt="" border="0" /></a><? }?>
<? if($lang=='th'){?><a href="http://test.uniquesofts.info/thaieyenew/th/th_home"><img src="http://test.uniquesofts.info/thaieyenew/images/logo.png" alt="" border="0" /></a><? }?>
</div>
