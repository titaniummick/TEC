...
<!--start header -->
<div id="header">
<div class="logo"><? if($lang!='th'){?><a href="home"><img src="http://test.uniquesofts.info/thaieyenew/images/logo.png" alt="" border="0" /></a><? }?>
<? if($lang=='th'){?><a href="th_home"><img src="http://test.uniquesofts.info/thaieyenew/images/logo.png" alt="" border="0" /></a><? }?>
</div>
